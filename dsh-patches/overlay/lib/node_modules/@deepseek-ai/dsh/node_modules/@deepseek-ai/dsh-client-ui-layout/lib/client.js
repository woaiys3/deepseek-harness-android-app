		...
		function AppFrame({ useStore, useSessions, usePanelInfo, actions, renderSlot, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				style: {
					...
					// Android 适配（移动端）：窄屏下侧边栏不占列宽 —— 改为浮层抽屉，
					// 避免手机上常驻一条窄栏挤占正文宽度（与 v1.x 移动端行为一致）。
					gridTemplateColumns: `${narrow ? 0 : cols.sidebar}px minmax(${cols.rightbar === 0 ? 0 : 400}px, 1fr) minmax(0px, ${narrow ? 0 : rightbarMax}px)`
				},
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						// Android 适配：窄屏展开时侧边栏以浮层抽屉形式覆盖在正文上方
						style: narrow && !sidebarCollapsed ? {
							position: "fixed",
							left: 0,
							top: 0,
							bottom: 0,
					...
					// Android 适配（移动端）：窄屏收起时在左上角给出三条杠按钮，
					// 点击展开侧边栏抽屉（与 mobile.css 为 .wSkVaW_header 预留的 52px 左内边距配套）。
					narrow && sidebarCollapsed && (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "dsh-mobile-menu-btn",
						"aria-label": "展开侧边栏",
						title: "展开侧边栏",
						style: {
							position: "fixed",
							...
							color: "var(--dsw-alias-label-secondary, #8b98a9)",
							cursor: "pointer",
					...
					// Android 适配：抽屉展开时的透明遮罩（点任意处收起，宽度不遮内容）
					narrow && !sidebarCollapsed && (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-mobile-scrim",
						style: {
							position: "fixed",
							inset: 0,
							zIndex: 25,
					...
					!sidebarCollapsed && !narrow && (0, react_jsx_runtime.jsx)(DragHandle, {
						side: "sidebar",
						left: cols.sidebar,
